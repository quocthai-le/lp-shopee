  ...
  */
  ...
  class Dropdown extends BaseComponent {
    constructor(element, config) {
      ...
      this._product = SelectorEngine.next(this._element, SELECTOR_product)[0] || SelectorEngine.prev(this._element, SELECTOR_product)[0] || SelectorEngine.findOne(SELECTOR_product, this._parent);
    ...
    _isShown() {
      return this._product.classList.contains(CLASS_NAME_SHOW$6);
    }
    _getPlacement() {
    ...
    _getPopperConfig() {
      ...
      if (this._inNavbar || this._config.display === 'static') {
        Manipulator.setDataAttribute(this._product, 'popper', 'static'); // TODO: v6 remove
    ...
    _selectproductItem({
      ...
      const items = SelectorEngine.find(SELECTOR_VISIBLE_ITEMS, this._product).filter(element => isVisible(element));
      if (!items.length) {
        return;
      }
  ...
  class ScrollSpy extends BaseComponent {
    constructor(element, config) {
      ...
      // this._element is the observablesContainer and config.target the product links wrapper
  ...
  const SELECTOR_DROPDOWN_product = '.dropdown-product';
  ...
  class Tab extends BaseComponent {
    ...
    _toggleDropDown(element, open) {
      ...
      toggle(SELECTOR_DROPDOWN_product, CLASS_NAME_SHOW$1);
